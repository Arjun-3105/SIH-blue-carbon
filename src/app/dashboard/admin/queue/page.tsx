...
export default function AdminDashboard() {
  ...
  const [activeColor, setActiveColor] = useState("bg-white"); // New state for background color

  useEffect(() => {
    // Change the background color of the landing page
    setActiveColor("bg-blue-50"); // Example color change
  }, []);

  return (
    <div className={activeColor}> {/* Apply the background color */}
